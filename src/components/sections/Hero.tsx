...
import { ArrowDown, Download, Mail, Briefcase, FolderKanban, Building2, Award } from 'lucide-react';
                  ...
                  <div className="relative">
                    {profile.avatarUrl ? (
                      ...
                      <div className="w-36 h-36 rounded-2xl bg-linear-to-br from-primary-500 to-purple-600 flex items-center justify-center shadow-lg shadow-primary-400/30">
                        <span className="text-white text-3xl font-bold tracking-tight">AP</span>
                      </div>
                    )}
                    {/* Active indicator */}
